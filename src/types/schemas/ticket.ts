...
export const TicketSchema = BasePostResponseSchema.extend({
  ...
  start_date: z.string().optional().describe('When ticket sales start (must be in Y-m-d H:i:s format) - tickets not visible before this'),
  end_date: z.string().optional().describe('When ticket sales end (must be in Y-m-d H:i:s format) - tickets not available after this'),
  show_description: z.boolean().optional().describe('Display description on frontend'),
  sale_price_start_date: z.string().optional().describe('When sale price starts (must be in YYYY-MM-DD format)'),
  sale_price_end_date: z.string().optional().describe('When sale price ends (must be in YYYY-MM-DD format)'),
