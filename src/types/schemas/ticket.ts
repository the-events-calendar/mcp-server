...
export const TicketSchema = BasePostSchema.extend({
  ...
  start_date: z.string().optional().describe('When ticket sales start (Y-m-d H:i:s format)'),
  end_date: z.string().optional().describe('When ticket sales end (Y-m-d H:i:s format)'),
  ...
  sale_price_start_date: z.string().optional().describe('When sale price starts (Y-m-d H:i:s format)'),
