...
export const TicketSchema = BasePostSchema.extend({
  ...
  start_date: z.string().optional().describe('When ticket sales start (flexible date formats: ISO, natural language, MySQL) - tickets not visible before this'),
  end_date: z.string().optional().describe('When ticket sales end (flexible date formats: ISO, natural language, MySQL) - tickets not available after this'),
  ...
  sale_price_start_date: z.string().optional().describe('When sale price starts (flexible date formats: ISO, natural language, MySQL)'),
  sale_price_end_date: z.string().optional().describe('When sale price ends (flexible date formats: ISO, natural language, MySQL)'),
}).meta({
  title: 'Ticket',
