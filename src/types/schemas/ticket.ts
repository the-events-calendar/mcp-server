...
export const TicketSchema = BasePostSchema.extend({
  ...
  event_id: z.number().optional().describe('ID of the associated event'),
  price: z.string().optional().describe('Ticket price (numeric string without currency symbols, e.g. "25.00")'),
